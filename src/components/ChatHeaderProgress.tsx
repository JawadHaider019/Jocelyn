...
export const ChatHeaderProgress: React.FC<ChatHeaderProgressProps> = ({
  ...
  return (
    <div
      className={`w-full max-w-2xl mx-auto mb-6 backdrop-blur-xl border rounded-2xl p-4 transition-colors ${
        isDark
    ...
    >
      <div className="flex items-center justify-between gap-3 mb-3">
          ...
          <div>
            ...
            <h2
              className={`text-sm font-medium leading-tight ${
                isDark ? 'text-white' : 'text-zinc-900 font-semibold'
              }`}
            >
              {stepTitle}
            </h2>
        ...
        <div className="flex items-center gap-2">
          <span
            className={`hidden sm:inline-flex items-center gap-1 text-[11px] font-medium px-2.5 py-1 rounded-full border backdrop-blur-md ${
              isDark
          ...
          <button
            ...
            className={`flex items-center gap-1.5 text-xs font-medium px-2.5 py-1.5 rounded-xl border backdrop-blur-md cursor-pointer transition-all ${
              isDark
      ...
      <div
        className={`w-full rounded-full h-2 overflow-hidden flex gap-1 p-0.5 border ${
          isDark ? 'bg-black/60 border-white/10' : 'bg-zinc-200/80 border-black/5'
        }`}
      >
